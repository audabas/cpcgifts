...
<body>
	...
	<div class="container">
		...
		<p>
			<ul>
				<li><a href="http://cpcgifts.fr/user?userID=6001">bastien09</a> (créateur de CPC Gifts)</li>
				<li><a href="http://cpcgifts.fr/user?userID=131001">sebarnolds</a></li>
				<li><a href="http://cpcgifts.fr/user?userID=12005">SiGarrett</a></li>
				<li><a href="http://cpcgifts.fr/user?userID=6005">Yakaaa</a></li>
			</ul>
